...
inline constexpr std::string_view RelationshipState = "state";
inline constexpr std::string_view RelationshipIsFriend = "isFriend";
inline constexpr std::string_view RelationshipIsBlocked = "isBlocked";
inline constexpr std::string_view RelationshipBlockedByTarget = "blockedByTarget";
inline constexpr std::string_view RelationshipOutgoingRequest = "outgoingRequest";
inline constexpr std::string_view RelationshipIncomingRequest = "incomingRequest";
