// Generated from ../backend/src/common/ws/ws-events.ts. Do not edit manually.
#pragma once
...
inline constexpr std::string_view Message = "messaging.message";
inline constexpr std::string_view Deleted = "messaging.deleted";
inline constexpr std::string_view Restored = "messaging.restored";
inline constexpr std::string_view Purged = "messaging.purged";
