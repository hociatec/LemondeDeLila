    ...
    bool isBlocked) const
{
    ...
    if (actionIndex == 1)
    {
        ...
        Schedule(
            lila::shared::errors::SocialProfileRemoveBusy,
            [service, id = *userId]() { service->RemoveFriend(id); },
            lila::shared::errors::SocialFriendRemoved,
    ...
    bool isBlocked) const
{
    ...
    {
        Schedule(
            lila::shared::errors::SocialProfileAcceptBusy,
            [service, id = *userId]() { service->AcceptFriend(id); },
            lila::shared::errors::SocialProfileAccepted,
    ...
    {
        Schedule(
            lila::shared::errors::SocialProfileRejectBusy,
            [service, id = *userId]() { service->RejectFriend(id); },
            lila::shared::errors::SocialProfileRejected,
            SocialSection::IncomingRequests);
        return;
    }
    ...
    bool isBlocked) const
{
    ...
    if (actionIndex == 0)
    {
        auto* service = &socialService_;
        Schedule(
            lila::shared::errors::SocialProfileCancelBusy,
            [service, id = *userId]() { service->CancelRequest(id); },
            lila::shared::errors::SocialProfileCanceled,
    ...
    std::optional<int> userId) const
{
    ...
    auto* service = &socialService_;
    Schedule(
        lila::shared::errors::SocialProfileActionUnblocked,
        [service, id = *userId]() { service->UnblockUser(id); },
        lila::shared::errors::SocialProfileUnblocked,
    ...
    std::function<void(std::optional<domain::SocialProfile>)> onSaved) const
{
    ...
    auto* service = &socialService_;
    callbacks_.runTask(
        lila::shared::errors::SocialSaveProfileBusy,
    ...
    SocialSection refreshSection) const
{
    ...
    Schedule(
        isBlocked
            ? lila::shared::errors::SocialProfileActionUnblocked
            : lila::shared::errors::SocialProfileActionBlocked,
        ...
        isBlocked
            ? lila::shared::errors::SocialProfileUnblocked
            : lila::shared::errors::SocialProfileBlocked,
        refreshSection);
}
