...
inline constexpr const char* SocialRelationshipStateMustBeObject = "L'état de la relation sociale doit être un objet JSON.";
...
inline constexpr const char* SocialLoadRelationshipFailed = "Chargement de la relation sociale impossible.";
