...
std::string Humanize(std::string_view key)
{
    static const std::pair<std::string_view, std::string_view> Known[]{
        ...
        {"botTurnDelayMs", "Attente avant la réponse d’un bot (ms)"},
        {"botStartDelayMs", "Attente avant la première action d’un bot (ms)"},
        {"botDrawDelayMs", "Attente après la pioche d’un bot (ms)"},
