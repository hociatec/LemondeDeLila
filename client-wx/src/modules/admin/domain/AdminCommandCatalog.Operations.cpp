...
void AppendOperationsCommands(std::vector<AdminCommand>& c)
{
    ...
    c.insert(c.end(), {
        ...
        {"sounds.upload", L"Ajouter ou remplacer un son", L"Choisissez l’écran et l’événement, puis un fichier WAV, OGG ou MP3 (250 Mio maximum).", T::HttpMultipart, "POST /api/admin/sounds/{soundId}", {}, R"({"soundId":"ClientOpened","filePath":""})"},
