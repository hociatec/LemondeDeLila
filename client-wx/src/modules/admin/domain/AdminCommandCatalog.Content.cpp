...
void AppendContentCommands(std::vector<AdminCommand>& c)
{
    ...
    c.insert(c.end(), {
        ...
        {"rooms.cleanup.preview", S::Rooms, L"Prévisualiser le nettoyage", L"Simulation excluant les joueurs actifs.", T::ApiWebSocket, std::string(ws::admin::rooms::Cleanup), {}, R"({"confirm":true,"dryRun":true,"includePrivate":false,"includeStarted":false,"olderThanMinutes":60,"limit":1000})"},
        ...
        {"games.update", S::Games, L"Modifier un jeu", L"Personnalisation du catalogue et du tchat.", T::ApiWebSocket, std::string(ws::admin::games::Update), {}, R"({"gameType":"","enabled":true,"name":"","description":"","rules":"","minPlayers":2,"maxPlayers":8,"status":"finished","chatEnabled":true,"chatSoundsEnabled":true})"},
        {"games.reset", S::Games, L"Réinitialiser un jeu", L"Supprimer toutes ses personnalisations.", T::ApiWebSocket, std::string(ws::admin::games::Reset), {}, R"({"gameType":""})", true},
        ...
        {"categories.create", S::Games, L"Créer une catégorie", L"La catégorie parente est facultative.", T::ApiWebSocket, std::string(ws::admin::games::CategoryCreate), std::string(ws::admin::games::Categories), R"({"name":"","parentId":null})"},
