...
void AppendContentCommands(std::vector<AdminCommand>& c)
{
    ...
    c.insert(c.end(), {
        ...
        {"mnemo.questions", L"Lister les questions", L"Filtres facultatifs catégorie/statut.", T::ApiWebSocket, std::string(ws::admin::quiz::mnemo::Questions), {}, R"({"categoryId":"","status":"pending"})"},
