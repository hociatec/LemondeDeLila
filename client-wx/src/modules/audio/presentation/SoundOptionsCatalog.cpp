...
constexpr std::array Options{
    ...
    SoundOption{domain::SoundCue::TavernClosed, L"Sortie de la taverne"},
    ...
    SoundOption{domain::SoundCue::RoomMemberJoined, L"Un participant rejoint la table"},
    SoundOption{domain::SoundCue::RoomMemberLeft, L"Un participant quitte la table"},
