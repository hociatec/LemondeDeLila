...
/**
 * Panneau Swing encapsulant le formulaire de connexion.
 */
public final class SwingLoginPanel extends JPanel implements LoginView {
    ...
    public void showView() {
        ...
        if (action != null) {
            ...
            SwingUtilities.invokeLater(() -> {
                Window window = SwingUtilities.getWindowAncestor(SwingLoginPanel.this);
