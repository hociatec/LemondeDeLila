...
exports.CaDerapeService = void 0;
...
const Rulebook = __importStar(require("./rulebook/ca.rulebook"));
const ca_derape_shortcuts_1 = require("./ca-derape.shortcuts");
let CaDerapeService = class CaDerapeService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = ca_definition_1.CA_DERAPE_GAME.displayName;
    description = 'Course chaotique sur 30 cases avec cartes Situation.';
    minPlayers = ca_definition_1.CA_DERAPE_GAME.minPlayers;
    maxPlayers = ca_definition_1.CA_DERAPE_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, ca_derape_shortcuts_1.buildCaDerapeShortcuts)(ctx);
    }
};
exports.CaDerapeService = CaDerapeService;
exports.CaDerapeService = CaDerapeService = __decorate([
...
//# sourceMappingURL=ca-derape.service.js.map