...
exports.EnAttendantMinuitService = void 0;
...
const minuit_shortcuts_1 = require("./minuit.shortcuts");
let EnAttendantMinuitService = class EnAttendantMinuitService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = minuit_definition_1.MINUIT_GAME.displayName;
    description = "Course de Noël jusqu'à Minuit.";
    minPlayers = minuit_definition_1.MINUIT_GAME.minPlayers;
    maxPlayers = minuit_definition_1.MINUIT_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, minuit_shortcuts_1.buildMinuitShortcuts)(ctx);
    }
};
exports.EnAttendantMinuitService = EnAttendantMinuitService;
exports.EnAttendantMinuitService = EnAttendantMinuitService = __decorate([
...
//# sourceMappingURL=en-attendant-minuit.service.js.map