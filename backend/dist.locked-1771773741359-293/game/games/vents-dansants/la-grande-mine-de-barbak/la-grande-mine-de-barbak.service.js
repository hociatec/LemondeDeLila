...
exports.LaGrandeMineDeBarbakService = void 0;
...
const la_grande_mine_de_barbak_shortcuts_1 = require("./la-grande-mine-de-barbak.shortcuts");
let LaGrandeMineDeBarbakService = class LaGrandeMineDeBarbakService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    gameType = 'la-grande-mine-de-barbak';
    category = 'JeuxDePlateaux';
    subcategory = 'VentsDansants';
    displayName = game_definition_1.LA_GRANDE_MINE_GAME.displayName;
    description = 'Explorez la mine, posez vos trésors et affrontez vos adversaires pour devenir le Nain suprême.';
    minPlayers = game_definition_1.LA_GRANDE_MINE_GAME.minPlayers;
    maxPlayers = game_definition_1.LA_GRANDE_MINE_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, la_grande_mine_de_barbak_shortcuts_1.buildLaGrandeMineDeBarbakShortcuts)(ctx);
    }
};
exports.LaGrandeMineDeBarbakService = LaGrandeMineDeBarbakService;
exports.LaGrandeMineDeBarbakService = LaGrandeMineDeBarbakService = __decorate([
...
//# sourceMappingURL=la-grande-mine-de-barbak.service.js.map