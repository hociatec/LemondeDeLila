...
exports.PimpMyRidePresenterService = void 0;
...
let PimpMyRidePresenterService = class PimpMyRidePresenterService {
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: game_definition_1.PIMP_MY_RIDE_GAME.phaseOrder.map((phase) => phase.id),
                victory: null,
            },
...
exports.PimpMyRidePresenterService = PimpMyRidePresenterService;
exports.PimpMyRidePresenterService = PimpMyRidePresenterService = __decorate([
    (0, common_1.Injectable)()
], PimpMyRidePresenterService);
//# sourceMappingURL=pimp-my-ride-presenter.service.js.map