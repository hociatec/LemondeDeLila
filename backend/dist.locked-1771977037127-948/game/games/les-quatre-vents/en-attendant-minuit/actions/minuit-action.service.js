...
let MinuitActionService = class MinuitActionService {
    ...
    handleChooseTarget(state, action) {
        ...
        if (ctx.kind === 'gift') {
            ...
            next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, currentId, MINUIT_PLAYER_NAME_OPTIONS)} offre un cadeau à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, targetPlayerId, MINUIT_PLAYER_NAME_OPTIONS)}.`);
