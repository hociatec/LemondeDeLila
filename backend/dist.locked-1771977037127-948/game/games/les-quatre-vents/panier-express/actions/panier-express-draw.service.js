...
var PanierExpressDrawService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PanierExpressDrawService = void 0;
...
let PanierExpressDrawService = class PanierExpressDrawService {
    static { PanierExpressDrawService_1 = this; }
    setup;
    core;
    utils;
    deckHelper;
    static MAX_INVENTORY = 5;
    ...
    drawCourse(state, playerId, standId) {
        ...
        const players = (state.players ?? []).map((player) => {
            ...
            if (inventory.length >= PanierExpressDrawService_1.MAX_INVENTORY) {
                discarded = 'full';
                return { ...player, inventory, basket };
            }
            kept = true;
        ...
        (0, playing_logger_1.playingLog)('panier.draw', {
...
exports.PanierExpressDrawService = PanierExpressDrawService;
exports.PanierExpressDrawService = PanierExpressDrawService = PanierExpressDrawService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [panier_express_setup_service_1.PanierExpressSetupService,
...
//# sourceMappingURL=panier-express-draw.service.js.map