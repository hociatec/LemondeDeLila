...
exports.AventureSauvageActionService = void 0;
...
let AventureSauvageActionService = class AventureSauvageActionService {
    ...
    handleChoosePawn(state, action) {
        ...
        const starterName = (0, player_name_helper_1.resolvePlayerNameFromState)(started, resolvedStarterId ?? players[0]?.id ?? 0);
    ...
    applyLanding(state, playerId, position) {
        ...
        if (landing.pending)
            return { ...next, pending: landing.pending };
        return next;
    }
    ...
    drawCard(meta, deck) {
        ...
        const drawPile = [...(decks[deck] ?? [])];
        const discardKey = deck === 'animal' ? 'discardAnimal' : 'discardPatte';
        const discardPile = [...(decks[discardKey] ?? [])];
...
exports.AventureSauvageActionService = AventureSauvageActionService;
exports.AventureSauvageActionService = AventureSauvageActionService = __decorate([
...
//# sourceMappingURL=aventure-sauvage-action.service.js.map