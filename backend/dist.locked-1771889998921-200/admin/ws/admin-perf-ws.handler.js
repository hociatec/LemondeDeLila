...
exports.AdminPerfWsHandler = void 0;
...
let AdminPerfWsHandler = class AdminPerfWsHandler {
    ...
    perfSnapshot(session, payload) {
        ...
        const dto = this.validator.validate(admin_ws_dto_1.AdminPerfSnapshotWsDto, payload ?? {});
        const snapshot = this.perf.snapshot({ windowSeconds: dto.windowSeconds });
        return { type: 'admin.perf.snapshot', payload: snapshot };
    }
};
exports.AdminPerfWsHandler = AdminPerfWsHandler;
exports.AdminPerfWsHandler = AdminPerfWsHandler = __decorate([
...
//# sourceMappingURL=admin-perf-ws.handler.js.map