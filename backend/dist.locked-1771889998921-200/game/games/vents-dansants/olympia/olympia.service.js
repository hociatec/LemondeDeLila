...
const olympia_shortcuts_1 = require("./olympia.shortcuts");
let OlympiaService = class OlympiaService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = game_definition_1.OLYMPIA_GAME.displayName;
    description = 'Accumulez un maximum de prestige divin en jouant vos héros, exploits, créatures, actions, attaques et événements.';
    minPlayers = game_definition_1.OLYMPIA_GAME.minPlayers;
    maxPlayers = game_definition_1.OLYMPIA_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, olympia_shortcuts_1.buildOlympiaShortcuts)(ctx);
    }
};
exports.OlympiaService = OlympiaService;
exports.OlympiaService = OlympiaService = __decorate([
...
//# sourceMappingURL=olympia.service.js.map