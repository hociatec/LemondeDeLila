...
describe('Contract fixtures', ()=>{
    it('parses game.state fixtures and contains expected keys', ()=>{
        ...
        const setupLifecycle = isJsonObject(setup.metadata) ? setup.metadata.lifecycle : undefined;
        const startedLifecycle = isJsonObject(started.metadata) ? started.metadata.lifecycle : undefined;
