...
Object.defineProperty(exports, "PimpMyRidePresenterService", {
    enumerable: true,
    get: function() {
        return PimpMyRidePresenterService;
    }
});
...
let PimpMyRidePresenterService = class PimpMyRidePresenterService {
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: _gamedefinition.PIMP_MY_RIDE_GAME.phaseOrder.map((phase)=>phase.id),
                victory: null
            },
...
PimpMyRidePresenterService = _ts_decorate([
