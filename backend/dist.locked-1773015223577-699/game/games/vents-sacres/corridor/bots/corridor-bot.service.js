...
let CorridorBotService = class CorridorBotService {
    getBotActions(state, botPlayerId) {
        ...
        const myGoalY = _rulebook.getGoalYForPlayer(state, botPlayerId);
        const oppGoalY = oppId != null ? _rulebook.getGoalYForPlayer(state, oppId) : null;
        ...
        const myDist = myPos != null ? _rulebook.shortestDistanceToGoal(meta, myPos, myGoalY) : null;
        const oppDist = oppPos != null && oppGoalY != null ? _rulebook.shortestDistanceToGoal(meta, oppPos, oppGoalY) : null;
        ...
        if (remaining > 0 && oppId != null && oppGoalY != null && oppPos != null && wallTargets.length > 0) {
        ...
        Math.random() < 0.35);
        if (wantAggressiveWall && wallTargets.length > 0 && myPos && oppPos && oppGoalY != null && myDist != null && oppDist != null) {
