...
_export(exports, {
    ...
    get getGoalYForPlayer () {
        return getGoalYForPlayer;
    },
    get getMetadata () {
        return getMetadata;
    },
    ...
    get isWallPlacementInBounds () {
        return isWallPlacementInBounds;
    },
    get isWinningPos () {
        return isWinningPos;
    },
    ...
    get listLegalPawnMoves () {
        return listLegalPawnMoves;
    },
    get listLegalWallPlacements () {
        return listLegalWallPlacements;
    },
    get overlapsOrCrosses () {
        return overlapsOrCrosses;
    },
    get parseKey () {
        return parseKey;
    },
    get shortestDistanceToGoal () {
        return shortestDistanceToGoal;
    },
    get validateMoveAction () {
        return validateMoveAction;
    },
    get validatePlaceWallAction () {
        return validatePlaceWallAction;
    },
    get wallSets () {
        return wallSets;
    },
    get wouldBlockAllPaths () {
...
function getGoalYForPlayer(state, playerId) {
    const meta = getMetadata(state);
    const size = meta?.size ?? 0;
    if (!size) return null;
...
function isWallPlacementInBounds(meta, wall) {
    ...
    return wall.x >= 0 && wall.y >= 0 && wall.x <= size - 2 && wall.y <= size - 2 && (wall.o === 'h' || wall.o === 'v');
}
...
function validatePlaceWallAction(state, action, actorId) {
    ...
    const orientation = o === 'v' || o === 'vertical' ? 'v' : o === 'h' || o === 'horizontal' ? 'h' : (()=>{
