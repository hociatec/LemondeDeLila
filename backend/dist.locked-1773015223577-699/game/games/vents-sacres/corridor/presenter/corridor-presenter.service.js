...
let CorridorPresenterService = class CorridorPresenterService extends _basepresenterservice.BasePresenterService {
    ...
    buildGridCellTags(state, userId, size) {
        ...
        const goalY = _rulebook.getGoalYForPlayer(state, userId);
    ...
    buildPendingStateForUser(state, _metadata, userId, _currentPlayerId) {
        ...
        return this.filterPendingForUser(state.pending ?? null, userId);
    }
