...
let LamaShortcutsService = class LamaShortcutsService {
    getShortcuts(ctx) {
        ...
        const trackerPlayed = tracker?.played === true || tracker?.played === 1 || String(tracker?.played ?? '').toLowerCase() === 'true';
        ...
        const allowPlayAfterDraw = meta?.allowPlayAfterDraw === true || meta?.allowPlayAfterDraw === 1 || String(meta?.allowPlayAfterDraw ?? '').toLowerCase() === 'true';
        ...
        return [
            ...
            (0, _shortcututils.actionShortcut)('P', canPassTurn ? 'lama_pass' : 'lama_quit'),
