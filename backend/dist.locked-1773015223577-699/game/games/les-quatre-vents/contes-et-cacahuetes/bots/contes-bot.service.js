...
Object.defineProperty(exports, "ContesBotService", {
    enumerable: true,
    get: function() {
        return ContesBotService;
    }
});
...
let ContesBotService = class ContesBotService {
    getBotActions(state, botPlayerId) {
        const pendingPlayerId = state.pending?.playerId ?? null;
        const current = state.turn?.currentPlayerId ?? null;
        if (current !== botPlayerId && !(typeof pendingPlayerId === 'number' && pendingPlayerId === botPlayerId)) {
            return [];
        }
