...
Object.defineProperty(exports, "ContesCacahuetesSetupService", {
    enumerable: true,
    get: function() {
        return ContesCacahuetesSetupService;
    }
});
...
let ContesCacahuetesSetupService = class ContesCacahuetesSetupService {
    hydrateInitialState(baseState) {
        const players = (0, _setupservicehelper.getSafePlayers)(baseState);
        const pawns = buildPawns();
        ...
        const starterPick = updatedPlayers.length > 0 ? this.random.nextInt(seedMeta, updatedPlayers.length) : {
            value: 0,
            meta: seedMeta
        };
        const setupStarterId = updatedPlayers.length > 0 ? updatedPlayers[Math.max(0, Math.min(updatedPlayers.length - 1, starterPick.value))]?.id ?? null : null;
        const metaBase = {
            tiles: buildTiles(),
            positions,
            setupStarterId,
        ...
        const pendingInfo = this.setupFlow.createSequentialPawnPending({
            ...
            pawns: pawns.filter((pawn)=>{
                const used = new Set(updatedPlayers.map((p)=>toText(p.pawn).trim()).filter((v)=>v.length > 0));
            ...
            choiceLabelBuilder: (pawn)=>toText(pawn.description).trim().length > 0 ? `${toText(pawn.label).trim()}: ${toText(pawn.description).trim()}` : toText(pawn.label).trim(),
...
ContesCacahuetesSetupService = _ts_decorate([
...
function buildTiles() {
    return [
        ...
        {
            type: 'conte',
            label: `Case Conte - Japon : Momotarō`
        },
        {
            type: 'surprise',
        ...
        {
            type: 'conte',
            label: `Case Conte - Russie : Vassilissa la très belle`
        },
        {
            type: 'bonus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Canada : L'ours géant et l'enfant`
        },
        {
            type: 'surprise',
        ...
        {
            type: 'conte',
            label: `Case Conte - Maroc : Le figuier magique`
        },
        {
            type: 'malus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Chine : La princesse éventail`
        },
        {
            type: 'bonus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Pérou : Le colibri courageux`
        },
        {
            type: 'malus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Égypte : Le secret du Nil`
        },
        {
            type: 'bonus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Inde : Le prince au cobra`
        },
        {
            type: 'bonus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Italie : Giufà et l'âne`
        },
        {
            type: 'malus',
            label: `Case Malus - Le sort s'emmêle... et vous avec.`
        },
        {
            type: 'conte',
            label: `Case Conte - Kenya : Le feu volant`
        },
        {
            type: 'bonus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Chili : La lune et le renard`
        },
        {
            type: 'surprise',
        ...
        {
            type: 'conte',
            label: `Case Conte - France : Le Petit Poucet`
        },
        {
            type: 'malus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Brésil : La tortue et le jaguar`
        },
        {
            type: 'surprise',
        ...
        {
            type: 'conte',
            label: `Case Conte - Iran : Le tapis volant`
        },
        {
            type: 'malus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Thaïlande : La mangue du roi`
        },
        {
            type: 'bonus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Vietnam : L'enfant des rizières`
        },
        {
            type: 'malus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Espagne : Le tambour enchanté`
        },
        {
            type: 'bonus',
        ...
        {
            type: 'conte',
            label: `Case Conte - Haïti : Ti-Jean et le diable`
        },
        {
            type: 'surprise',
        ...
        {
            type: 'conte',
            label: `Case Conte - Turquie : Nasreddine et l'âne`
        },
        {
            type: 'malus',
            label: `Case Malus - Le destin vous teste... courage !`
        },
        {
            type: 'conte',
        ...
        {
            type: 'conte',
            label: `Case Conte - Pologne : Le roi grenouille`
        },
        {
            type: 'finish',
