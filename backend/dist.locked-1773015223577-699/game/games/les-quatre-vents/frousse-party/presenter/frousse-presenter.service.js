...
Object.defineProperty(exports, "FroussePresenterService", {
    enumerable: true,
    get: function() {
        return FroussePresenterService;
    }
});
...
let FroussePresenterService = class FroussePresenterService {
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: _froussedefinition.FROUSSE_GAME.phaseOrder.map((p)=>p.id),
                victory: null
            },
...
FroussePresenterService = _ts_decorate([
