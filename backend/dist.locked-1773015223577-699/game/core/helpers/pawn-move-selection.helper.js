...
_export(exports, {
    get getPendingPawnMoveOptions () {
        return getPendingPawnMoveOptions;
    },
    get listPendingPawnMoveActions () {
        return listPendingPawnMoveActions;
    },
    get resolvePendingPawnMove () {
        return resolvePendingPawnMove;
    }
});
function getPendingPawnMoveOptions(pending) {
    const movesRaw = Array.isArray(pending?.data?.moves) ? pending.data.moves : [];
