...
Object.defineProperty(exports, "GridRenderService", {
    enumerable: true,
    get: function() {
...
let GridRenderService = class GridRenderService {
    attachGridRenderDescriptors(state) {
        ...
        if (!gridExisting || typeof gridExisting !== 'object' || Array.isArray(gridExisting)) {
            return state;
        }
        const grid = {
            ...gridExisting
        ...
        if (!blockedEdges || typeof blockedEdges !== 'object' || Array.isArray(blockedEdges)) {
            return state;
        }
        const sizeRaw = grid.size;
        const size = typeof sizeRaw === 'number' ? sizeRaw : typeof sizeRaw === 'string' ? Number.parseInt(sizeRaw, 10) : NaN;
...
GridRenderService = _ts_decorate([
