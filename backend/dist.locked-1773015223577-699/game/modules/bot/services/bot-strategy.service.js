...
Object.defineProperty(exports, "BotStrategyService", {
    enumerable: true,
    get: function() {
        return BotStrategyService;
    }
});
...
let BotStrategyService = class BotStrategyService {
   ...
   */ chooseProfile(actions, ctx, profile = 'random', opts = {}) {
        const scoreFn = opts.score ?? ((action)=>{
        ...
        return this.choose(actions, ctx, {
            ...opts,
            score: scoreFn
        });
    }
};
BotStrategyService = _ts_decorate([
