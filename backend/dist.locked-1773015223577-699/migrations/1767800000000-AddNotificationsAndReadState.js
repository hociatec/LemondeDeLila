...
Object.defineProperty(exports, "AddNotificationsAndReadState1767800000000", {
    enumerable: true,
    get: function() {
        return AddNotificationsAndReadState1767800000000;
    }
});
let AddNotificationsAndReadState1767800000000 = class AddNotificationsAndReadState1767800000000 {
    ...
    async down(queryRunner) {
        await queryRunner.query(`DROP INDEX \`idx_messaging_private_messages_recipient_unread\` ON \`messaging_private_messages\`;`);
        await queryRunner.query(`ALTER TABLE \`messaging_private_messages\` DROP COLUMN \`read_by_recipient_at\`;`);
        await queryRunner.query(`DROP TABLE \`notification_inbox_items\`;`);
    }
    constructor(){
        this.name = 'AddNotificationsAndReadState1767800000000';
    }
};
