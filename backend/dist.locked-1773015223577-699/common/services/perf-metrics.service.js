...
Object.defineProperty(exports, "PerfMetricsService", {
    enumerable: true,
    get: function() {
        return PerfMetricsService;
    }
});
const _common = require("@nestjs/common");
const _playinglogger = require("../utils/playing-logger");
...
let PerfMetricsService = class PerfMetricsService {
    ...
    record(event, ms, meta) {
        ...
        if (entry.ms >= 250) {
            (0, _playinglogger.playingLog)('perf.sample', {
                event,
                ms: entry.ms,
                ...meta
            });
    ...
    snapshot(options) {
        ...
        for (const [event, entries] of this.buffers.entries()){
            ...
            const c2sValues = recent.map((e)=>e.meta ? e.meta['clientToServerMs'] : null).filter((v)=>typeof v === 'number' && Number.isFinite(v));
    ...
    constructor(){
        this.maxEntriesPerEvent = 500;
        this.buffers = new Map();
    }
};
PerfMetricsService = _ts_decorate([
