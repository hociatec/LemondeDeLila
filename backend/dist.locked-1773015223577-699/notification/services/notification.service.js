...
let NotificationService = class NotificationService {
    ...
    async notifyUser(userId, type, payload) {
        ...
        try {
            ...
            this.logger.warn(`Echec publication notification userId=${userId} type=${type}`, err instanceof Error ? err.stack : String(err));
        }
    ...
    async notifyAll(type, payload) {
        ...
        try {
            ...
            // Best-effort: do not break API calls if Redis/pubsub is down.
            this.logger.warn(`Echec publication notification broadcast type=${type}`, err instanceof Error ? err.stack : String(err));
        }
