...
exports.PrimalisService = void 0;
...
const primalis_shortcuts_1 = require("./shortcuts/primalis.shortcuts");
let PrimalisService = class PrimalisService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = primalis_definition_1.PRIMALIS_GAME.displayName;
    description = 'Survivez à la comète : construisez votre tribu de dinosaures et nourrissez-la avant la catastrophe finale.';
    minPlayers = primalis_definition_1.PRIMALIS_GAME.minPlayers;
    maxPlayers = primalis_definition_1.PRIMALIS_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, primalis_shortcuts_1.buildPrimalisShortcuts)(ctx);
    }
};
exports.PrimalisService = PrimalisService;
exports.PrimalisService = PrimalisService = __decorate([
...
//# sourceMappingURL=primalis.service.js.map