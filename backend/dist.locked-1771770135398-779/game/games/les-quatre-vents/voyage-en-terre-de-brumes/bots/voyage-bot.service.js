...
exports.VoyageBotService = void 0;
...
let VoyageBotService = class VoyageBotService {
    botRunner;
    ...
    getBotActions(state, botPlayerId) {
        ...
        return this.botRunner.choose(available, { state, playerId: botPlayerId }, 'random', {
            preferTypes: ['choose_target', 'answer_quiz', 'draw', 'roll'],
            fallbackTypes: ['roll'],
        });
    }
};
exports.VoyageBotService = VoyageBotService;
exports.VoyageBotService = VoyageBotService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [bot_runner_service_1.BotRunnerService])
], VoyageBotService);
//# sourceMappingURL=voyage-bot.service.js.map