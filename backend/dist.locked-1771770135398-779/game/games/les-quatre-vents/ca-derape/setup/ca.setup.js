...
exports.CaSetupService = CaSetupService;
exports.CaSetupService = CaSetupService = __decorate([
...
function buildDeck() {
    const cards = [];
    const push = (id, title, category, kind, text, moveDelta) => cards.push({ id, title, category, kind, text, moveDelta });
    const a = [
        [
...
//# sourceMappingURL=ca.setup.js.map