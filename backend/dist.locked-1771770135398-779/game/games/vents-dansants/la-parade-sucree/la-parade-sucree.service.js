...
exports.LaParadeSucreeService = void 0;
...
const la_parade_sucree_shortcuts_1 = require("./la-parade-sucree.shortcuts");
let LaParadeSucreeService = class LaParadeSucreeService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    gameType = 'la-parade-sucree';
    category = 'JeuxDePlateaux';
    subcategory = 'VentsDansants';
    displayName = game_definition_1.LA_PARADE_SUCREE_GAME.displayName;
    description = 'Posez les cartes dans lordre et collectionnez les friandises des cases spéciales.';
    minPlayers = game_definition_1.LA_PARADE_SUCREE_GAME.minPlayers;
    maxPlayers = game_definition_1.LA_PARADE_SUCREE_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, la_parade_sucree_shortcuts_1.buildLaParadeSucreeShortcuts)(ctx);
    }
};
exports.LaParadeSucreeService = LaParadeSucreeService;
exports.LaParadeSucreeService = LaParadeSucreeService = __decorate([
...
//# sourceMappingURL=la-parade-sucree.service.js.map