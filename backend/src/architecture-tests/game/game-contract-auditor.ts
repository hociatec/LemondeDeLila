import type { GameSingleActionDto } from '../../game/core/application/models/game-action.model';
import type { GameRuntime } from '../../game/core/application/contracts/game-runtime.interface';
import { FixedGameClock } from '../../game/core/application/models/game-execution-context.model';
import type { GameStateEntity } from '../../game/core/application/models/game-state.model';
import { DeclarativeGameRuntime } from '../../game/core/application/runtime/declarative-game.runtime';
import type {
  CompiledGameDefinition,
  GameActionMap,
} from '../../game/core/application/runtime/game-definition';
import { GameCommandExecutorService } from '../../game/core/application/services/game-command-executor.service';
import { GameEngineService } from '../../game/core/application/services/game-engine.service';
import { InMemoryGameSessionStore } from '../../game/core/infrastructure/persistence/memory/in-memory-game-session.store';
import { GameExecutionScopeService } from '../../game/core/application/services/game-execution-scope.service';
