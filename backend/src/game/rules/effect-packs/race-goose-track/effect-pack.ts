...
} from '../../schemas/json-goose-race-schema';
import { gooseRaceRules } from '../../recipes/goose-race.recipes';
...
export const effectPack = defineJsonEffectPack({
  ...
  handlers: (context, compiled) => ({
    ...
    bot: context.recipeBot('race-goose-track-roll'),
  }),
  actions: (compiled) => ({
    'race-goose-track-roll': compiled.roll,
  }),
});
