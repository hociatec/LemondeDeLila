...
} from '../../schemas/json-event-race-schema';
import { eventRaceRules } from '../../recipes/event-race.recipes';
...
export const effectPack = defineJsonEffectPack({
  ...
  handlers: (context, compiled) => ({
    ...
    bot: context.recipeBot(['race-event-cards-draw', 'race-event-cards-roll']),
  }),
  actions: (compiled) => ({
