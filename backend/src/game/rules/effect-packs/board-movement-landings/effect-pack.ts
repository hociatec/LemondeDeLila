import { assertBoardPawnCapacity } from '../../schemas/json-board-pawn-capacity';
import { defineJsonEffectPack } from '../../../engine/runtime/contracts/json-effect-pack';
import {
  jsonBoardSchema,
  assertBoardReferences,
} from '../../schemas/json-board-schema';
import { boardTurnRules } from '../../recipes/board-turn.recipes';
