...
import {
  addOlympiaCardToDiscard,
  addOlympiaCardToHand,
  drawOneOlympiaCard,
  removeOlympiaCardFromHand,
} from './olympia-action.utils';
...
export class OlympiaActionService {
  ...
  private drawOneCard(
    ...
    return drawOneOlympiaCard(meta, deck);
  }
  ...
  private removeCardFromHand(
    ...
    return removeOlympiaCardFromHand(meta, playerId, cardId);
  }
  ...
  private addCardToHand(
    ...
    return addOlympiaCardToHand(meta, playerId, cardId);
  }
  ...
  private addCardToDiscard(
    ...
    return addOlympiaCardToDiscard(meta, cardId);
  }
