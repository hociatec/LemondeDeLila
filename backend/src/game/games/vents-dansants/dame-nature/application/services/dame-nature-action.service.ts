...
import {
  addDameNatureCardToDiscardMeta,
  addDameNatureCardToHandMeta,
  drawOneDameNatureCard,
  getDameNatureCardName,
  removeDameNatureCardFromHandMeta,
} from './dame-nature-action.utils';
...
export class DameNatureActionService {
  ...
  private drawOneCard(meta: DameNatureMetadata): {
    ...
    return drawOneDameNatureCard(this.deckPolicies, meta);
  }
  ...
  private addCardToHand(
    ...
    const meta = this.getMeta(state);
    return this.setMeta(state, addDameNatureCardToHandMeta(meta, playerId, cardId));
  }
  ...
  private removeCardFromHand(
    ...
    return this.setMeta(
      state,
      removeDameNatureCardFromHandMeta(meta, playerId, cardId),
    );
  }
  ...
  private addCardToDiscard(
    ...
    const meta = this.getMeta(state);
    return this.setMeta(state, addDameNatureCardToDiscardMeta(meta, cardId));
  }
  ...
  private getCardName(cardId: string): string {
    return getDameNatureCardName(cardId);
  }
