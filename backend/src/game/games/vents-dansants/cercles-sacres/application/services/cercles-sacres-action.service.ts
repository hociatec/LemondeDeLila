...
import {
  addCerclesSacresCardToDiscard,
  addCerclesSacresCardToHand,
  drawOneCerclesSacresCard,
  removeCerclesSacresCardFromHand,
  removeCerclesSacresCardsFromHand,
} from './cercles-sacres-action.utils';
import {
  CERCLES_SACRES_GOAL,
...
export class CerclesSacresActionService {
  ...
  private drawForPlayer(
    ...
    return {
      cardId,
      meta: addCerclesSacresCardToHand(withCard, playerId, cardId),
    };
  }
  ...
  private drawOneCard(meta: CerclesSacresMetadata): {
    ...
    return drawOneCerclesSacresCard(this.deckPolicies, meta);
  }
  ...
  private removeCardsFromHand(
    ...
    return removeCerclesSacresCardsFromHand(meta, playerId, cardIds);
  }
  ...
  private removeCardFromHand(
    ...
    return removeCerclesSacresCardFromHand(meta, playerId, cardId);
  }
  ...
  private addCardToDiscard(
    ...
    return addCerclesSacresCardToDiscard(meta, cardId);
  }
