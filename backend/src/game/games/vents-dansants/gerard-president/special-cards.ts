...
const RAW_GERARD_PRESIDENT_SPECIAL_CARDS: RawGerardPresidentSpecialCard[] = [
  ...
  },
  {
    ...
    description:
      'Tu choisis un joueur ciblé : après avoir joué cette carte, chaque joueur suivant doit ajouter un adjectif ridicule à son prénom avant de le poser. Exemple : « Gérard-Écureuil-Volant. »',
    effect: 'effet-domino',
  },
  {
