...
describe('PanierExpressService', () => {
  ...
  it('expose correctement les pending non-quiz et les vues joueurs', () => {
    ...
    // Le raccourci P devient g̩n̩rique c̫t̩ client (pas sp̩cifique Panier Express).
    expect(
  ...
  it("d̩cr̩mente le tour de plateau lors d'un recul d'̩change qui repasse la case d̩part", () => {
  ...
  it("g̬re l'̩change impossible en reculant le joueur sans pending", () => {
    const state: any = service.hydrateInitialState({
      players: [
        { id: 1, username: 'A', inventory: [] },
        { id: 2, username: 'B', inventory: [] },
