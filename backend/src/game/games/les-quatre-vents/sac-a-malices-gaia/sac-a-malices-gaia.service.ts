...
import { SacAMalicesGaiaSetupService } from './setup/sac-a-malices-gaia-setup.service';

@Injectable()
export class SacAMalicesGaiaService implements GameRulesAdapter, OnModuleInit {
  readonly gameType = 'sac-a-malices-gaia';
  readonly category = 'JeuxDePlateaux';
  readonly subcategory = 'LesQuatreVents';
  readonly displayName = 'Sac à Malices — Gaïa';
  readonly description = 'Variante écologique.';
  readonly minPlayers = SAC_A_MALICES_GAME.minPlayers;
  readonly maxPlayers = SAC_A_MALICES_GAME.maxPlayers;

  constructor(
    private readonly registry: GameRegistryService,
    private readonly setup: SacAMalicesGaiaSetupService,
