...
import { SacAMalicesGaiaService } from './sac-a-malices-gaia.service';
...
@Module({
  ...
  providers: [
    SacAMalicesGaiaService,
    SacAMalicesGaiaSetupService,
    SacAMalicesActionService,
    SacAMalicesPresenterService,
    SacAMalicesBotService,
  ],
  exports: [SacAMalicesGaiaService],
})
export class SacAMalicesGaiaModule {}
