...
@Injectable()
export class SacAMalicesRouteDesFlandresService
  implements GameRulesAdapter, OnModuleInit
{
  readonly gameType = 'sac-a-malices-route-des-flandres';
  readonly category = 'JeuxDePlateaux';
  readonly subcategory = 'LesQuatreVents';
  readonly displayName = 'Sac à Malices — La Route des Flandres';
  readonly description = 'Variante Lille (La Route des Flandres).';
  readonly minPlayers = SAC_A_MALICES_GAME.minPlayers;
  readonly maxPlayers = SAC_A_MALICES_GAME.maxPlayers;

  constructor(
    private readonly registry: GameRegistryService,
    private readonly setup: SacAMalicesRouteDesFlandresSetupService,
