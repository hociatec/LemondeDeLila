...
import { SacAMalicesPintzelCouronnesService } from './sac-a-malices-pintzel-couronnes.service';
...
@Module({
  ...
  providers: [
    SacAMalicesPintzelCouronnesService,
    SacAMalicesPintzelCouronnesSetupService,
    SacAMalicesActionService,
    SacAMalicesPresenterService,
    SacAMalicesBotService,
  ],
  exports: [SacAMalicesPintzelCouronnesService],
})
export class SacAMalicesPintzelCouronnesModule {}
