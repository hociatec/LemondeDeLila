...
import { SacAMalicesPintzelCouronnesSetupService } from './setup/sac-a-malices-pintzel-couronnes-setup.service';

@Injectable()
export class SacAMalicesPintzelCouronnesService
  implements GameRulesAdapter, OnModuleInit
{
  readonly gameType = 'sac-a-malices-pintzel-couronnes';
  readonly category = 'JeuxDePlateaux';
  readonly subcategory = 'LesQuatreVents';
  readonly displayName = 'Sac à Malices — Pintzel & Couronnes';
  readonly description = 'Variante Strasbourg (Pintzel & Couronnes).';
  readonly minPlayers = SAC_A_MALICES_GAME.minPlayers;
  readonly maxPlayers = SAC_A_MALICES_GAME.maxPlayers;

  constructor(
    private readonly registry: GameRegistryService,
    private readonly setup: SacAMalicesPintzelCouronnesSetupService,
