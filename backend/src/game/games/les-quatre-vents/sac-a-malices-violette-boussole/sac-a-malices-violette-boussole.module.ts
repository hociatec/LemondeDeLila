...
import { SacAMalicesVioletteBoussoleService } from './sac-a-malices-violette-boussole.service';
...
@Module({
  ...
  providers: [
    SacAMalicesVioletteBoussoleService,
    SacAMalicesVioletteBoussoleSetupService,
    SacAMalicesActionService,
    SacAMalicesPresenterService,
    SacAMalicesBotService,
  ],
  exports: [SacAMalicesVioletteBoussoleService],
})
export class SacAMalicesVioletteBoussoleModule {}
