...
@Injectable()
export class SacAMalicesCosmosCreditService
  implements GameRulesAdapter, OnModuleInit
{
  readonly gameType = 'sac-a-malices-cosmos-credit';
  readonly category = 'JeuxDePlateaux';
  readonly subcategory = 'LesQuatreVents';
  readonly displayName = 'Sac à Malices — Cosmos & Crédit';
  readonly description = 'Variante cosmique.';
  readonly minPlayers = 1;
  readonly maxPlayers = SAC_A_MALICES_GAME.maxPlayers;

  constructor(
    private readonly registry: GameRegistryService,
    private readonly setup: SacAMalicesCosmosCreditSetupService,
