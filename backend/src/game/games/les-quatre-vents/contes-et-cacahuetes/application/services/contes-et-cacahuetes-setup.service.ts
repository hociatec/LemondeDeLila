...
function buildDecks(): ContesCacahuetesMetadata['decks'] {
  ...
  const surprise: ContesCard[] = [
    ...
    },
    {
      ...
      text: `Un nuage de poussière de rire se répand ! Chaque joueur lance un petit dé de 1 à 3. Celui qui a le plus grand avance d'une case. Remarque : s'il y a égalité au chiffre trois, ils avancent ensemble.`,
    },
    {
      id: 6,
      type: 'surprise',
