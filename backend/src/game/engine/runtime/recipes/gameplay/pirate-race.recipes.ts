...
export function pirateRaceRules(source: PirateRaceProgram) {
...
function isDeckKind(value: string): value is PirateDeckKind {
...
function resolveCard(
  ...
  drawAndResolve<State, PirateRaceCard>(ctx, {
