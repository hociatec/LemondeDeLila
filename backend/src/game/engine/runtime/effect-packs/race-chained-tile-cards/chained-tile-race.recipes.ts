...
function effects(program: ChainedTileRaceProgram) {
  return {
    ...
    'race-chained-tile-cards.next-tile': defineEffect<
      State,
      { tile: 'bonus' | 'folie' }
    >({
    ...
    'race-chained-tile-cards.repeat-roll': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
    ...
    'race-chained-tile-cards.swap': defineEffect<State, Record<string, never>>({
      input: gameInput.object({}),
    ...
    'race-chained-tile-cards.boutique': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
    ...
    'race-chained-tile-cards.random-move': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
    ...
    'race-chained-tile-cards.finish-if-slide': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
