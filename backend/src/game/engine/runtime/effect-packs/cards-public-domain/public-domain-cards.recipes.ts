...
export function publicDomainCardsRules(source: PublicDomainCardsProgram) {
  ...
  return {
    ...
    effects: publicDomainEffects(program, cards),
    enumerate,
  };
}
function publicDomainEffects(
  ...
  return {
    'cards-public-domain.remove-domain': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
    ...
    'cards-public-domain.remove-domain-all': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
    ...
    'cards-public-domain.recover-discard': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
    ...
    'cards-public-domain.draw-passive': defineEffect<State, { count: number }>({
      input: gameInput.object({
        count: gameInput.number({ integer: true, min: 0 }),
      }),
    ...
    'cards-public-domain.trim-hand': defineEffect<State, Record<string, never>>(
      {
        input: gameInput.object({}),
        apply: ({ actorPlayerId, ctx }) => {
    ...
    'cards-public-domain.double-next-player': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
    ...
    'cards-public-domain.remove-treasure': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
    ...
    'cards-public-domain.finish': defineEffect<State, Record<string, never>>({
      input: gameInput.object({}),
      apply: ({ actorPlayerId, ctx }) => {
        if (actorPlayerId != null)
          ctx.events.message(
...
function finish(program: PublicDomainCardsProgram, ctx: Context) {
