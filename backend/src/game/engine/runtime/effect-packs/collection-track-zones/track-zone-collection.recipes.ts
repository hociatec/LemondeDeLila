...
import { drawEvent, raceTurn } from '../../recipes/gameplay/card-dice.recipes';

type State = Record<string, never>;
type Context = GameContext<State>;
type Card = { id: string | number };

export function trackZoneCollectionRules(source: TrackZoneCollectionProgram) {
...
function finish(program: TrackZoneCollectionProgram, ctx: Context): void {
