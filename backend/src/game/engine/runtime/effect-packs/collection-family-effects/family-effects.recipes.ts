import type { FamilyEffectsProgram, ProfessionFamilyCard } from './program';
...
function effects(
  ...
  return {
    'collection-family-effects.exchange-random': defineEffect<
      State,
      Record<string, never>
    >({
      input: empty,
    ...
    'collection-family-effects.complete-vanished': defineEffect<
      State,
      Record<string, never>
    >({
      input: empty,
    ...
    'collection-family-effects.mix-hands': defineEffect<
      State,
      Record<string, never>
    >({
      input: empty,
    ...
    'collection-family-effects.pass-knowledge': defineEffect<
      State,
      Record<string, never>
    >({
      input: empty,
...
function maybeFinish(program: FamilyEffectsProgram, ctx: Context): void {
