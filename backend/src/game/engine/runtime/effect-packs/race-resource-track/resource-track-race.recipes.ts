import type { ResourceTrackFace, ResourceTrackRaceProgram } from './program';
import type { GameContext } from '../../definitions/game-author-context';
import { defineEvent } from '../../events/game-event-definition';
import { gameInput } from '../../actions/game-input-schema';
import { rollDice } from '../../recipes/gameplay/card-dice.recipes';
...
function finishIfImpact(program: ResourceTrackRaceProgram, ctx: Context): void {
  if (
    !ctx.players
      .all()
      .some(
