...
export function pairedPawnRaceRules(source: PairedPawnRaceProgram) {
  ...
  return {
    ...
    effects: pairedPawnEffects(program),
  };
}
function applyTile(
...
function pairedPawnEffects(program: PairedPawnRaceProgram) {
  return {
    ...
    'pairedPawn.transfer-token': defineEffect<State, Record<string, never>>({
      input: gameInput.object({}),
    ...
    'pairedPawn.share-advance': defineEffect<State, Record<string, never>>({
      input: gameInput.object({}),
    ...
    'pairedPawn.meeting': defineEffect<State, Record<string, never>>({
      input: gameInput.object({}),
      apply: ({ actorPlayerId, targetPlayerIds, ctx }) => {
        if (actorPlayerId != null)
    ...
    'pairedPawn.roll-move': defineEffect<State, Record<string, never>>({
      input: gameInput.object({}),
    ...
    'pairedPawn.roll-threshold-move': defineEffect<
      State,
      Record<string, never>
    >({
      input: gameInput.object({}),
