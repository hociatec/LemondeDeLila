...
describe('JSON pirate race schema', () => {
  it('rejects an invalid pirate collection limit', () => {
    expect(() =>
      parseJsonGame({
        schemaVersion: 1,
        contentVersion: '1',
        ...
        actions: { roll: { recipe: 'pirate-race-roll' } },
        victory: { kind: 'by-pirate-race' },
        pirateRace: {
          trackId: 'track',
          diceId: 'main',
          tiles: [],
