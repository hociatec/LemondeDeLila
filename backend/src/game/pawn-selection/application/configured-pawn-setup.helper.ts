...
import type { SetupFlowService } from '../../core/application/services/setup-flow.service';
import { resolvePlayerNameFromState } from '../../core/application/helpers/player-name.helper';
import type { ResolvePlayerNameOptions } from '../../core/application/helpers/player-name.helper';
...
type ConfiguredSetupLogger = Pick<
  import('../../core/application/services/game-core.service').GameCoreService,
  'appendLog'
>;
