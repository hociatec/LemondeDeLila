...
} from '../model/interactive-exchange.model';
...
export class InteractiveExchangeService {
  ...
  start(
    ...
    return {
      kind: 'started',
      state: { ...state, pending: pending as any },
      pending,
    };
  }
  ...
  chooseTarget(
    ...
    const pending = state.pending as any as InteractiveExchangePending | null;
    ...
    return {
      kind: 'updated',
      state: { ...state, pending: nextPending as any },
      pending: nextPending,
    };
  }
  ...
  chooseGive(
    ...
    return {
      kind: 'offered',
      state: { ...picked.state, pending: offer as any },
      offer,
    };
