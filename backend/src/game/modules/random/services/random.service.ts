...
import { nextRngFloat, nextRngInt } from '../../../../common/utils/seeded-rng';

@Injectable()
export class RandomService {
  createMetaRng<TMeta extends Record<string, any>>(
    meta: TMeta,
  ): {
    rng: () => number;
    getMeta: () => TMeta;
  ...
  nextFloat<TMeta extends Record<string, any>>(
    meta: TMeta,
  ): {
    value: number;
    meta: TMeta;
  ...
  nextInt<TMeta extends Record<string, any>>(
    meta: TMeta,
    maxExclusive: number,
  ...
  rollDice<TMeta extends Record<string, any>>(
    meta: TMeta,
    sides: number,
  ...
  pickIndex<TMeta extends Record<string, any>>(
    meta: TMeta,
    length: number,
  ...
  pickOne<T, TMeta extends Record<string, any>>(
    meta: TMeta,
    values: readonly T[],
  ...
  shuffle<T, TMeta extends Record<string, any>>(
    meta: TMeta,
    values: readonly T[],
  ): { values: T[]; meta: TMeta } {
