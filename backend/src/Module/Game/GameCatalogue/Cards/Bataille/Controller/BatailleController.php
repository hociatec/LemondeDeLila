...
namespace App\Module\Game\GameCatalogue\Cards\Bataille\Controller;

use App\Module\Game\Entity\Room;
use App\Module\Game\Entity\Game;
use App\Module\Game\GameCatalogue\Cards\Bataille\Service\BatailleService;
...
#[Route('/api/games/bataille')]
class BatailleController extends AbstractController
{
    public function __construct(
        private BatailleService $svc,
        private StatsAggregator $stats,
        private RoomRealtimeNotifier $realtime
    ) {
    }

    #[Route('/rooms/{id}/state', name: 'bataille_state', methods: ['GET'])]
    ...
    #[Route('/rooms/{id}/move', name: 'bataille_move', methods: ['POST'])]
