...
namespace App\Module\Game\GameCatalogue\Dice\Pig\Controller;

use App\Module\Game\Entity\Room;
use App\Module\Game\Entity\Game;
use App\Module\Game\GameCatalogue\Dice\Pig\Service\PigService;
...
class PigController extends AbstractController
{
    public function __construct(
        private PigService $svc,
        private StatsAggregator $stats,
        private RoomRealtimeNotifier $realtime
    ) {
    }

    #[Route('/rooms/{id}/state', name: 'pig_state', methods: ['GET'])]
    ...
    #[Route('/rooms/{id}/move', name: 'pig_move', methods: ['POST'])]
