...
Object.defineProperty(exports, "OlympiaPresenterService", {
    enumerable: true,
    get: function() {
        return OlympiaPresenterService;
    }
});
...
let OlympiaPresenterService = class OlympiaPresenterService {
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: _gamedefinition.OLYMPIA_GAME.phaseOrder.map((phase)=>phase.id),
                victory: null
            },
...
OlympiaPresenterService = _ts_decorate([
