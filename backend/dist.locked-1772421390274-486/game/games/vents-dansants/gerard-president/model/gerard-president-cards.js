...
_export(exports, {
    get GERARD_PRESIDENT_NAMES () {
        return GERARD_PRESIDENT_NAMES;
    },
    get GERARD_PRESIDENT_SPECIAL_CARDS () {
        return GERARD_PRESIDENT_SPECIAL_CARDS;
    },
    get GERARD_PRESIDENT_THEMES () {
        return GERARD_PRESIDENT_THEMES;
    }
});
const GERARD_PRESIDENT_NAMES = [
    'Annie',
    'Cindy',
    'Rodrigue',
    'Eude',
...
const GERARD_PRESIDENT_SPECIAL_CARDS = [
    {
        id: 'special-sabotage',
        name: 'Carte Sabotage',
    ...
    },
    {
        ...
        description: 'Tu choisis un joueur ciblé : après avoir joué cette carte, chaque joueur suivant doit ajouter un adjectif ridicule à son prénom avant de le poser. Exemple : ?Gérard-?cureuil-Volant.?',
        effect: 'effet-domino'
    },
    {
