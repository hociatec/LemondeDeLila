...
exports.LesAbsurdissimesService = void 0;
...
const les_absurdissimes_shortcuts_1 = require("./les-absurdissimes.shortcuts");
let LesAbsurdissimesService = class LesAbsurdissimesService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    gameType = game_definition_1.ABSURDISSIMES_GAME.id;
    category = 'Cartes';
    subcategory = 'VentsDansants';
    displayName = game_definition_1.ABSURDISSIMES_GAME.displayName;
    description = 'Proposez les réponses les plus absurdes et convainquez le juge pour remporter la manche.';
    minPlayers = game_definition_1.ABSURDISSIMES_GAME.minPlayers;
    maxPlayers = game_definition_1.ABSURDISSIMES_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, les_absurdissimes_shortcuts_1.buildAbsurdissimesShortcuts)(ctx);
    }
};
exports.LesAbsurdissimesService = LesAbsurdissimesService;
exports.LesAbsurdissimesService = LesAbsurdissimesService = __decorate([
...
//# sourceMappingURL=les-absurdissimes.service.js.map