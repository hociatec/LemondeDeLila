...
exports.AventureSauvagePresenterService = void 0;
...
let AventureSauvagePresenterService = class AventureSauvagePresenterService {
    ...
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: game_definition_1.AVENTURE_SAUVAGE_GAME.phaseOrder.map((p) => p.id),
                victory: null,
            },
...
exports.AventureSauvagePresenterService = AventureSauvagePresenterService;
exports.AventureSauvagePresenterService = AventureSauvagePresenterService = __decorate([
...
//# sourceMappingURL=aventure-sauvage-presenter.service.js.map