...
exports.GaloponsPresenterService = void 0;
...
let GaloponsPresenterService = class GaloponsPresenterService {
    boardPayload;
    ...
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: galopons_definition_1.GALOPONS_GAME.phaseOrder.map((p) => p.id),
                victory: null,
            },
...
exports.GaloponsPresenterService = GaloponsPresenterService;
exports.GaloponsPresenterService = GaloponsPresenterService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [board_payload_service_1.BoardPayloadService])
], GaloponsPresenterService);
//# sourceMappingURL=galopons-presenter.service.js.map