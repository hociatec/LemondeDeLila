...
## But du jeu
Parcourez 1 000 pattes avant vos adversaires en enchaînant les cartes Pattes, en évitant ou en éliminant les obstacles et en tirant avantage des cartes Parades ou Bots.
...
- Bots (Réserve secrète, Chat Ninja, Patte blindée, Passage de Star) : talents permanents, souvent des protections ou des exemptions de certaines contraintes.
...
2. Jouez une carte :
   ...
   - Carte Bot : active un talent permanent (protection, bonus de pioche, exemption, etc.).
...
- Un obstacle bloque toutes les cartes Pattes tant qu’il n’est pas éliminé (sauf Bots spécifiques).
- Les Bots restent actifs jusqu’à la fin de la partie et leurs effets peuvent se cumuler.
