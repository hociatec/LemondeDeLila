...
exports.ENTRE_RITES_CARD_BY_ID = exports.ENTRE_RITES_CUSTOM_FAMILY_SIZE = exports.ENTRE_RITES_DECK = exports.ENTRE_RITES_SPECIAL_CARDS = exports.ENTRE_RITES_FAMILY_CARDS = void 0;
...
exports.ENTRE_RITES_FAMILY_CARDS = createFamilyCards();
exports.ENTRE_RITES_SPECIAL_CARDS = SPECIALS;
exports.ENTRE_RITES_DECK = [
    ...exports.ENTRE_RITES_FAMILY_CARDS,
    ...exports.ENTRE_RITES_SPECIAL_CARDS,
];
exports.ENTRE_RITES_CUSTOM_FAMILY_SIZE = Object.fromEntries(FAMILY_DEFINITIONS.map((family) => [family.id, family.members.length]));
exports.ENTRE_RITES_CARD_BY_ID = Object.fromEntries(exports.ENTRE_RITES_DECK.map((card) => [card.id, card]));
//# sourceMappingURL=entre-rites-cards.js.map