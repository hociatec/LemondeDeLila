...
exports.AFondLesBallonsBotService = void 0;
...
let AFondLesBallonsBotService = class AFondLesBallonsBotService {
    botRunner;
    ...
    getBotActions(state, botPlayerId) {
        ...
        const isPendingForMe = typeof pendingPlayerId === 'number' && pendingPlayerId === botPlayerId;
        if (current !== botPlayerId && !isPendingForMe)
            return [];
...
exports.AFondLesBallonsBotService = AFondLesBallonsBotService;
exports.AFondLesBallonsBotService = AFondLesBallonsBotService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [bot_runner_service_1.BotRunnerService])
], AFondLesBallonsBotService);
//# sourceMappingURL=a-fond-les-ballons-bot.service.js.map