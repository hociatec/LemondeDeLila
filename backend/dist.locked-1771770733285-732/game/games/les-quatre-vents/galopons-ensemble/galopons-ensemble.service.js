...
exports.GaloponsEnsembleService = void 0;
...
const galopons_shortcuts_1 = require("./galopons.shortcuts");
let GaloponsEnsembleService = class GaloponsEnsembleService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = galopons_definition_1.GALOPONS_GAME.displayName;
    description = 'Course équestre avec pommes et cartes.';
    minPlayers = galopons_definition_1.GALOPONS_GAME.minPlayers;
    maxPlayers = galopons_definition_1.GALOPONS_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, galopons_shortcuts_1.buildGaloponsShortcuts)(ctx);
    }
    shouldAnnounceBoardArrivals() {
        return true;
    }
};
exports.GaloponsEnsembleService = GaloponsEnsembleService;
exports.GaloponsEnsembleService = GaloponsEnsembleService = __decorate([
...
//# sourceMappingURL=galopons-ensemble.service.js.map