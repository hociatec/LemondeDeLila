...
export interface GameDefinition<TGameId extends string = string, TRoleId extends string = string, TActionType extends string = string, TPhaseId extends string = string, TVictory = unknown> {
    id: TGameId;
    displayName: string;
    minPlayers: number;
    maxPlayers: number;
