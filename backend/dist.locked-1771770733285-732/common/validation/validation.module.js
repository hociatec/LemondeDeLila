...
const payload_validation_service_1 = require("./payload-validation.service");
...
exports.ValidationModule = ValidationModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [payload_validation_service_1.PayloadValidationService],
        exports: [payload_validation_service_1.PayloadValidationService],
    })
], ValidationModule);
