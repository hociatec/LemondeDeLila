...
Object.defineProperty(exports, "GaloponsPresenterService", {
    enumerable: true,
    get: function() {
        return GaloponsPresenterService;
    }
});
...
let GaloponsPresenterService = class GaloponsPresenterService {
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: _galoponsdefinition.GALOPONS_GAME.phaseOrder.map((p)=>p.id),
                victory: null
            },
            ...
            extras: {
                ...
                ui: {
                    panels: {
                        ...
                        apples: {
                            title: 'Pommes',
                            message: applesLines.length ? applesLines.join('\n') : 'Pommes: indisponible.'
                        }
                    }
                },
                apples: meta.apples ?? {}
...
GaloponsPresenterService = _ts_decorate([
