...
exports.ensureSeededRng = ensureSeededRng;
exports.nextRngFloat = nextRngFloat;
exports.nextRngInt = nextRngInt;
...
function ensureSeededRng(meta) {
    const current = meta['rng'] && typeof meta['rng'] === 'object'
        ? meta['rng']
        : null;
    const seed = normalizeSeed(current?.seed) ??
