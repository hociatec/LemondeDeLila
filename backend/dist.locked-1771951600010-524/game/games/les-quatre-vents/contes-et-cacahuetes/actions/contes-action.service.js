...
let ContesActionService = class ContesActionService {
    ...
    handleRoll(state) {
        ...
        next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, currentId)} lance le dé : "${rollOut.roll}".`);
    ...
    handleRerollDecision(state, reroll) {
        ...
        if (reroll) {
            ...
            next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} relance le dé : "${out.roll}".`);
            next = this.applyMoveFromRoll(next, playerId, out.roll, 0);
        }
        else {
            const roll = Number(pending.data.baseRoll);
            next = { ...next, lastRoll: roll };
            next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} garde le résultat "${roll}".`);
    ...
    handleChooseTarget(state, action) {
        ...
        if (ctx === 'grimoire_voyageur') {
            ...
            next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, targetPlayerId)} avance d’1 case.`);
            return this.moveBy(next, targetPlayerId, 1, 0);
        }
        if (ctx === 'key_gold_choose_target') {
            return this.setPending(next, {
                type: 'choose_option',
                label: `Clé d’or : choisissez l’effet à appliquer à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, targetPlayerId)} (Bonus/Malus).`,
                playerId,
                blocking: true,
                choices: ['Bonus', 'Malus'],
    ...
    handleChooseNumber(state, action) {
        ...
        if (nextPlayerId != null) {
            return this.setPending(next, {
                type: 'choose_number',
                label: `Poussière de rire : ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, nextPlayerId)}, choisissez un nombre entre 1 et 3 puis Entrée.`,
        ...
        next = this.core.appendLog(next, `Poussière de rire : plus grand choix = ${max}. ${winners.map((id) => (0, player_name_helper_1.resolvePlayerNameFromState)(next, id)).join(', ')} avance(nt) d’1 case.`);
    ...
    handleChooseOption(state, action) {
        ...
        if (ctx === 'wish_ephemere') {
            ...
            if (option === 'Échanger')
                return this.startChooseTarget(next, playerId, 'wish_swap', 'Choisissez un joueur pour échanger vos positions.');
    ...
    handleChooseCard(state, action) {
        ...
        if (ctx.startsWith('abondance_keep_one:')) {
            next = this.core.appendLog(next, `Corne d’abondance : ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} garde "${pick.title}".`);
    ...
    applyConteTile(state, playerId, depth) {
        ...
        if (ignore && this.canUseBonusCards(state, playerId)) {
            ...
            next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} ignore l’effet Conte (Cape d’invisibilité) et avance d’1 case.`);
    ...
    applyBonusEffectById(state, playerId, id, depth) {
        ...
        switch (id) {
            ...
            case 2:
                ...
                return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} gagne un parchemin enchanté (1 relance).`);
            case 3:
            ...
            case 4:
                ...
                return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} obtient une Cape d’invisibilité (prochaine case Conte ignorée).`);
            case 5:
            ...
            case 7:
                ...
                return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} obtient la Clé d’or (sur Conte : Bonus/Malus pour un autre joueur).`);
            case 8:
    ...
    applyMalusEffectById(state, playerId, id, depth) {
        ...
        switch (id) {
            ...
            case 11: {
                ...
                next = { ...next, metadata: { ...(next.metadata ?? {}), ...out.meta } };
                if (out.roll >= 4)
                    return this.core.appendLog(next, `Énigme infernale : "${out.roll}" (réussi).`);
    ...
    applySurpriseEffectById(state, playerId, id, depth) {
        ...
        switch (id) {
            ...
            case 8:
                ...
                return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} lira à l’envers : prochain tour en reculant.`);
            case 9:
                return this.setPending(next, {
                    type: 'choose_option',
            ...
            case 10:
                ...
                return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} est protégé(e) de la prochaine carte Malus.`);
            case 11:
    ...
    startGiveBonusChoice(state, giverId, targetId) {
        ...
        if (!tokens.length) {
            return this.core.appendLog(state, `${(0, player_name_helper_1.resolvePlayerNameFromState)(state, giverId)} n'a aucune carte Bonus à donner.`);
        }
        return this.setPending(state, {
            type: 'choose_card',
            label: `Choisissez la carte Bonus à donner à ${(0, player_name_helper_1.resolvePlayerNameFromState)(state, targetId)}, puis Entrée.`,
            playerId: giverId,
            blocking: true,
    ...
    startStealTokenChoice(state, thiefId, fromId) {
        ...
        if (!cards.length) {
            return this.core.appendLog(state, `${(0, player_name_helper_1.resolvePlayerNameFromState)(state, fromId)} n’a aucune carte Bonus ou Surprise à voler.`);
        }
        if (cards.length === 1) {
            const only = cards[0];
            const next = this.core.appendLog(state, `Vol : ${(0, player_name_helper_1.resolvePlayerNameFromState)(state, thiefId)} prend "${only.title}" à ${(0, player_name_helper_1.resolvePlayerNameFromState)(state, fromId)}.`);
        ...
        return this.setPending(state, {
            type: 'choose_card',
            label: `Filet magique : choisissez la carte à voler à ${(0, player_name_helper_1.resolvePlayerNameFromState)(state, fromId)}, puis Entrée.`,
            playerId: thiefId,
            blocking: true,
    ...
    transferBonusToken(state, fromId, toId, bonusId) {
        ...
        if (bonusId === 3) {
            ...
            return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, fromId)} donne une Amulette protectrice à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, toId)}.`);
        }
        if (bonusId === 4) {
            ...
            return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, fromId)} donne une Cape d’invisibilité à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, toId)}.`);
        }
        if (bonusId === 7) {
            ...
            return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, fromId)} donne la Clé d’or à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, toId)}.`);
        }
        if (bonusId === 14) {
            ...
            return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, fromId)} donne Feuille magique à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, toId)}.`);
        }
        if (bonusId === 2) {
            ...
            return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, fromId)} donne un Parchemin enchanté à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, toId)}.`);
        }
        return next;
    }
    transferSurpriseToken(state, fromId, toId, surpriseId) {
        ...
        if (surpriseId === 8) {
            ...
            return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, fromId)} donne Livre à l’envers à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, toId)}.`);
        }
        if (surpriseId === 10) {
            ...
            return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, fromId)} donne Dragon de papier à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, toId)}.`);
        }
        return next;
    }
    takeOneBonusToken(state, fromId, toId) {
        ...
        if (!tokens.length) {
            return this.core.appendLog(state, `${(0, player_name_helper_1.resolvePlayerNameFromState)(state, fromId)} n'a aucune carte Bonus à donner.`);
        }
    ...
    swapPositions(state, aId, bId) {
        ...
        next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, aId)} échange sa position avec ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, bId)}.`);
        return next;
    }
    ...
    onAnyPlayerPassedBlocked(state, moverId, moverPos) {
        ...
        for (const pid of toClear) {
            ...
            next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, pid)} n’est plus bloqué(e).`);
        }
        return {
            ...next,
            metadata: {
    ...
    blockUntilPassed(state, playerId) {
        ...
        return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} est bloqué(e) jusqu’à ce qu’un autre joueur atteigne ou dépasse sa case.`);
    }
    ...
    autoSkipIfBlocked(state, currentId) {
        ...
        if (typeof blocked !== 'number')
            return state;
        const msg = `${(0, player_name_helper_1.resolvePlayerNameFromState)(state, currentId)} est bloqué(e) (Loup dans la forêt) : tour passé.`;
