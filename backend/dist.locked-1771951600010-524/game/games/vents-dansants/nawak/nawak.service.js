...
const nawak_shortcuts_1 = require("./nawak.shortcuts");
let NawakService = class NawakService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = game_definition_1.NAWAK_GAME.displayName;
    description = 'Répondez aux défis absurdes, votez pour les réponses étrangères et cumulez les votes.';
    minPlayers = game_definition_1.NAWAK_GAME.minPlayers;
    maxPlayers = game_definition_1.NAWAK_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, nawak_shortcuts_1.buildNawakShortcuts)(ctx);
    }
};
exports.NawakService = NawakService;
exports.NawakService = NawakService = __decorate([
...
//# sourceMappingURL=nawak.service.js.map