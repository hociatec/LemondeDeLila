...
exports.ContesCacahuetesSetupService = void 0;
...
let ContesCacahuetesSetupService = class ContesCacahuetesSetupService {
    ...
    hydrateInitialState(baseState) {
        ...
        const starterPick = updatedPlayers.length > 0
            ? this.random.nextInt(seedMeta, updatedPlayers.length)
            : { value: 0, meta: seedMeta };
        const setupStarterId = updatedPlayers.length > 0
            ? (updatedPlayers[Math.max(0, Math.min(updatedPlayers.length - 1, starterPick.value))]?.id ?? null)
            : null;
        const metaBase = {
            tiles: buildTiles(),
            positions,
        ...
        const pendingInfo = this.setupFlow.createSequentialPawnPending({
            ...
            pawns: pawns
                .filter((pawn) => {
                const used = new Set(updatedPlayers
            ...
            choiceLabelBuilder: (pawn) => toText(pawn.description).trim().length > 0
...
exports.ContesCacahuetesSetupService = ContesCacahuetesSetupService;
exports.ContesCacahuetesSetupService = ContesCacahuetesSetupService = __decorate([
...
//# sourceMappingURL=contes-et-cacahuetes-setup.service.js.map