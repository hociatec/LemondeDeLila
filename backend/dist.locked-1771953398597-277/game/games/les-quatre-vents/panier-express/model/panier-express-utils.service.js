...
var PanierExpressUtils_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PanierExpressUtils = void 0;
const common_1 = require("@nestjs/common");
let PanierExpressUtils = class PanierExpressUtils {
    static { PanierExpressUtils_1 = this; }
    static COURSE_LABELS = {
        cepe: 'cèpe',
    ...
    normalizePlayer(player) {
        return {
            id: player.id,
            username: typeof player.username === 'string'
                ? player.username
                : `Joueur ${player.id}`,
    ...
    isGameInProgress(state) {
        ...
        return (status === 'finished' ||
            ...
            players.some((p) => {
                const hasList = Array.isArray(p.shoppingList) &&
                    p.shoppingList.length > 0;
                const hasBasket = Array.isArray(p.basket) && p.basket.length > 0;
                const hasInventory = Array.isArray(p.inventory) &&
    ...
    formatCourseLabel(courseId) {
        ...
        if (!raw)
            return '';
        return PanierExpressUtils_1.COURSE_LABELS[raw] ?? raw;
    }
    ...
    formatEventLabel(eventId) {
        ...
        if (!raw)
            return '';
        const direct = PanierExpressUtils_1.EVENT_LABELS[raw];
        if (direct)
            return direct;
        const tokenMap = {
            echange: 'échange',
...
exports.PanierExpressUtils = PanierExpressUtils;
exports.PanierExpressUtils = PanierExpressUtils = PanierExpressUtils_1 = __decorate([
    (0, common_1.Injectable)()
], PanierExpressUtils);
//# sourceMappingURL=panier-express-utils.service.js.map