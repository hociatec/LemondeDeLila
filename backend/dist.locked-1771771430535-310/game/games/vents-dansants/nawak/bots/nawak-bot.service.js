...
exports.NawakBotService = void 0;
...
let NawakBotService = class NawakBotService {
    ...
    getBotActions(state, botPlayerId) {
        ...
        if (!actions.length)
            return [];
        return this.botRunner.choose(actions, { state, playerId: botPlayerId }, 'random', { preferTypes, fallbackTypes });
    }
};
exports.NawakBotService = NawakBotService;
exports.NawakBotService = NawakBotService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [bot_runner_service_1.BotRunnerService])
], NawakBotService);
//# sourceMappingURL=nawak-bot.service.js.map