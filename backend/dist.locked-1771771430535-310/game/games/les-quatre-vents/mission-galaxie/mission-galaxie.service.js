...
exports.MissionGalaxieService = void 0;
...
const mission_galaxie_shortcuts_1 = require("./shortcuts/mission-galaxie.shortcuts");
let MissionGalaxieService = class MissionGalaxieService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = mission_galaxie_definition_1.MISSION_GALAXIE_GAME.displayName;
    description = 'Course cosmique autour de 50 cases : questions, défis et événements vous propulsent vers la planète légendaire.';
    minPlayers = mission_galaxie_definition_1.MISSION_GALAXIE_GAME.minPlayers;
    maxPlayers = mission_galaxie_definition_1.MISSION_GALAXIE_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, mission_galaxie_shortcuts_1.buildMissionGalaxieShortcuts)(ctx);
    }
};
exports.MissionGalaxieService = MissionGalaxieService;
exports.MissionGalaxieService = MissionGalaxieService = __decorate([
...
//# sourceMappingURL=mission-galaxie.service.js.map