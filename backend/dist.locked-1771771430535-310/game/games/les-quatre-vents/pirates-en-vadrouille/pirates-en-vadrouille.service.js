...
exports.PiratesEnVadrouilleService = void 0;
...
const pirates_en_vadrouille_shortcuts_1 = require("./shortcuts/pirates-en-vadrouille.shortcuts");
let PiratesEnVadrouilleService = class PiratesEnVadrouilleService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = pirates_en_vadrouille_definition_1.PIRATES_GAME.displayName;
    description = 'Parcourez l’île Papayousse, piochez bonus ou obstacles et récoltez trésors et pièces d’or.';
    minPlayers = pirates_en_vadrouille_definition_1.PIRATES_GAME.minPlayers;
    maxPlayers = pirates_en_vadrouille_definition_1.PIRATES_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, pirates_en_vadrouille_shortcuts_1.buildPiratesEnVadrouilleShortcuts)(ctx);
    }
};
exports.PiratesEnVadrouilleService = PiratesEnVadrouilleService;
exports.PiratesEnVadrouilleService = PiratesEnVadrouilleService = __decorate([
...
//# sourceMappingURL=pirates-en-vadrouille.service.js.map