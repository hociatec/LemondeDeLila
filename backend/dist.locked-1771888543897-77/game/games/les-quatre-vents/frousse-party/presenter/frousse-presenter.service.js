...
exports.FroussePresenterService = void 0;
...
let FroussePresenterService = class FroussePresenterService {
    boardPayload;
    ...
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: frousse_definition_1.FROUSSE_GAME.phaseOrder.map((p) => p.id),
                victory: null,
            },
...
exports.FroussePresenterService = FroussePresenterService;
exports.FroussePresenterService = FroussePresenterService = __decorate([
...
//# sourceMappingURL=frousse-presenter.service.js.map