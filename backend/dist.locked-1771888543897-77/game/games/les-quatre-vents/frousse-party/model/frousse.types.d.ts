...
export type FrousseTile = {
    n: number;
    title: string;
    type: FrousseTileType;
};
...
export type FrousseCardsJsonV1 = {
    version: 1;
    cards: FrousseCard[];
};
export type FrousseBoardJsonV1 = {
    version: 1;
    tiles: FrousseTile[];
};
export type FroussePawnsJsonV1 = {
    version: 1;
    pawns: FroussePawn[];
};
