export type VoyageTileType = 'start' | 'finish' | 'neutral' | 'rest' | 'passage' | 'legend' | 'farce' | 'treasure' | 'landscape';
...
export type VoyageBoardJsonV1 = {
    version: 1;
    tiles: VoyageTile[];
};
export type VoyageCardsJsonV1 = {
    version: 1;
    cards: VoyageCard[];
};
