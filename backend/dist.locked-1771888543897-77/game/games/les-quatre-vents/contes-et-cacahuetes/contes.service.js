...
const contes_shortcuts_1 = require("./contes.shortcuts");
let ContesService = class ContesService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = game_definition_1.CONTES_CACAHUETES_GAME.displayName;
    description = 'Course sur 60 cases avec contes, bonus, malus et surprises.';
    minPlayers = game_definition_1.CONTES_CACAHUETES_GAME.minPlayers;
    maxPlayers = game_definition_1.CONTES_CACAHUETES_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, contes_shortcuts_1.buildContesShortcuts)(ctx);
    }
};
exports.ContesService = ContesService;
exports.ContesService = ContesService = __decorate([
...
//# sourceMappingURL=contes.service.js.map