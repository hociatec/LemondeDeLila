...
exports.FouleesFantastiquesBotService = void 0;
...
let FouleesFantastiquesBotService = class FouleesFantastiquesBotService {
    botRunner;
    ...
    getBotActions(state, botPlayerId) {
        ...
        if (current !== botPlayerId)
            return [];
        const available = FouleesFantastiquesRulebook.getAvailableActions(state, botPlayerId);
...
exports.FouleesFantastiquesBotService = FouleesFantastiquesBotService;
exports.FouleesFantastiquesBotService = FouleesFantastiquesBotService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [bot_runner_service_1.BotRunnerService])
], FouleesFantastiquesBotService);
//# sourceMappingURL=foulees-fantastiques-bot.service.js.map