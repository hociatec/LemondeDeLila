...
let ClientUpdatesUploadService = class ClientUpdatesUploadService {
    ...
    async uploadChunk(params) {
        ...
        if (!fs.existsSync(metaPath)) {
            throw new common_1.BadRequestException('Upload introuvable.');
        }
    ...
    async uploadComplete(params) {
        ...
        try {
            ...
            if (meta.completedAt) {
                throw new common_1.ConflictException('Upload déjà finalisé.');
            }
...
exports.ClientUpdatesUploadService = ClientUpdatesUploadService = __decorate([
