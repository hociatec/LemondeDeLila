...
exports.CERCLES_SACRES_CARD_BY_ID = exports.CERCLES_SACRES_DECK = void 0;
const TOTEM_NAMES = [
    'L?Aigle visionnaire',
    'Le Loup protecteur',
    'L?Ours guérisseur',
...
exports.CERCLES_SACRES_DECK = deck;
exports.CERCLES_SACRES_CARD_BY_ID = Object.fromEntries(deck.map((card) => [card.id, card]));
//# sourceMappingURL=cercles-sacres-cards.js.map