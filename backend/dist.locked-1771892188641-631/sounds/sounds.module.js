...
const admin_sounds_controller_1 = require("./admin-sounds.controller");
...
exports.SoundsModule = SoundsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [sounds_controller_1.SoundsController, admin_sounds_controller_1.AdminSoundsController],
        providers: [sounds_service_1.SoundsService],
        exports: [sounds_service_1.SoundsService],
    })
], SoundsModule);
