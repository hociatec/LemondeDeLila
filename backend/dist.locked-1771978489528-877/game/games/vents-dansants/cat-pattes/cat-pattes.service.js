...
exports.CatPattesService = void 0;
...
const cat_pattes_shortcuts_1 = require("./cat-pattes.shortcuts");
let CatPattesService = class CatPattesService extends abstract_game_service_1.AbstractGameService {
    setup;
    actions;
    presenter;
    bots;
    ...
    displayName = game_definition_1.CAT_PATTES_GAME.displayName;
    description = 'Course féline jusqu’à 1 000 pattes.';
    minPlayers = game_definition_1.CAT_PATTES_GAME.minPlayers;
    maxPlayers = game_definition_1.CAT_PATTES_GAME.maxPlayers;
    ...
    getShortcuts(ctx) {
        return (0, cat_pattes_shortcuts_1.buildCatPattesShortcuts)(ctx);
    }
};
exports.CatPattesService = CatPattesService;
exports.CatPattesService = CatPattesService = __decorate([
...
//# sourceMappingURL=cat-pattes.service.js.map