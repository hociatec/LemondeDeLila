...
let GaloponsActionService = class GaloponsActionService {
    ...
    handleChooseTarget(state, action) {
        ...
        if (ctx.kind === 'give_apple') {
            ...
            if (a <= 0) {
                next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, currentId)} n'a pas de pomme à donner.`);
                if (ctx.replayAfter)
                    return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, currentId)} rejoue.`);
                return this.turns.advanceTurn(next);
            }
            ...
            meta = { ...meta, apples: nextApples, ious: nextIous };
            next = { ...next, metadata: { ...(next.metadata ?? {}), ...meta } };
            next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, currentId)} donne une pomme à ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, targetPlayerId)}.`);
        ...
        if (ctx.kind === 'help_advance') {
            ...
            next = { ...next, metadata: { ...(next.metadata ?? {}), ...meta } };
            next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, currentId)} reçoit une pomme en remerciement.`);
            if (ctx.replayAfter)
                return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, currentId)} rejoue.`);
            return this.turns.advanceTurn(next);
        }
    ...
    applyLanding(state, playerId) {
        ...
        if (tile.type === 'finish') {
            if (!meta.finish?.triggered) {
                ...
                next = { ...next, metadata: { ...(next.metadata ?? {}), ...meta } };
                next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} atteint l'Écurie finale (+1 pomme).`);
            }
            return next;
        }
    ...
    applyCard(state, playerId, card) {
        ...
        if (/Défaussez-vous d''une pomme/i.test(text) ||
            ...
            return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} n'a pas de pomme à défausser.`);
        }
