...
exports.PrimalisPresenterService = void 0;
...
let PrimalisPresenterService = class PrimalisPresenterService {
    ...
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: primalis_definition_1.PRIMALIS_GAME.phaseOrder.map((p) => p.id),
                victory: null,
            },
...
exports.PrimalisPresenterService = PrimalisPresenterService;
exports.PrimalisPresenterService = PrimalisPresenterService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [board_payload_service_1.BoardPayloadService])
], PrimalisPresenterService);
//# sourceMappingURL=primalis-presenter.service.js.map