export type ToutPresDeMamanTileType = 'start' | 'neutral' | 'token' | 'card' | 'bonds' | 'slide' | 'storm' | 'nest' | 'meeting' | 'finish';
...
export type ToutPresDeMamanMetadata = ToutPresDeMamanDecks & ToutPresDeMamanDiscards & {
