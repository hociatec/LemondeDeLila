    ...
    drawAndApply(state, playerId, type, depth) {
        if (type === 'malus') {
            ...
            if (ignore && this.canUseBonusCards(state, playerId)) {
                ...
                next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} ignore l’effet Malus (Cape d’invisibilité) et avance d’1 case.`);
    ...
    applyBonusEffectById(state, playerId, id, depth) {
        ...
        switch (id) {
            ...
            case 4:
                ...
                return this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, playerId)} obtient une Cape d’invisibilité (prochaine case Malus ignorée).`);
            case 5:
