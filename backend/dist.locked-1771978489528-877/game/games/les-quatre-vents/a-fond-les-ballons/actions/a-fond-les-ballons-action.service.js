...
let AFondLesBallonsActionService = class AFondLesBallonsActionService {
    ...
    handleSwapChooseTarget(state, action) {
        ...
        next = this.core.appendLog(next, `${(0, player_name_helper_1.resolvePlayerNameFromState)(next, currentId)} échange sa place avec ${(0, player_name_helper_1.resolvePlayerNameFromState)(next, targetPlayerId)}.`);
        next = this.decrementTrapImmunity(next, currentId);
        return this.advanceTurnWithSkipLogs(next);
    }
    handleDraw(state) {
