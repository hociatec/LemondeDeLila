...
let ClientUpdatesService = ClientUpdatesService_1 = class ClientUpdatesService {
    logger = new common_1.Logger(ClientUpdatesService_1.name);
    updatesDir;
    metaPath;
...
<html lang="fr">
  ...
  <body>
    ...
    async applyZip(zipPath) {
        ...
        let releasesDir = path.join(parent, 'client-win.releases');
        ...
        try {
            ...
            this.logger.warn(`Impossible de préparer le dossier de backups (${releasesDir}). ` +
...
exports.ClientUpdatesService = ClientUpdatesService = ClientUpdatesService_1 = __decorate([
