...
Object.defineProperty(exports, "CerclesSacresPresenterService", {
    enumerable: true,
    get: function() {
        return CerclesSacresPresenterService;
    }
});
...
let CerclesSacresPresenterService = class CerclesSacresPresenterService {
    exposeStateForUser(state, userId) {
        ...
        return {
            ...state,
            catalog: {
                phases: _gamedefinition.CERCLES_SACRES_GAME.phaseOrder.map((phase)=>phase.id),
                victory: null
            },
...
CerclesSacresPresenterService = _ts_decorate([
