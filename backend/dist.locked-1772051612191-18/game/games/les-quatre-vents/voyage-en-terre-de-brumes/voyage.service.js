...
Object.defineProperty(exports, "VoyageService", {
    enumerable: true,
    get: function() {
...
const _voyageshortcuts = require("./voyage.shortcuts");
...
let VoyageService = class VoyageService extends _abstractgameservice.AbstractGameService {
    ...
    getShortcuts(ctx) {
        return (0, _voyageshortcuts.buildVoyageShortcuts)(ctx);
    }
    constructor(registry, setup, actions, presenter, bots){
        super(registry), this.setup = setup, this.actions = actions, this.presenter = presenter, this.bots = bots, this.gameType = 'voyage-en-terre-de-brumes', this.category = 'JeuxDePlateaux', this.subcategory = 'LesQuatreVents', this.displayName = _voyagedefinition.VOYAGE_GAME.displayName, this.description = 'Voyage en Irlande : quiz de légendes, farces et trésors.', this.minPlayers = _voyagedefinition.VOYAGE_GAME.minPlayers, this.maxPlayers = _voyagedefinition.VOYAGE_GAME.maxPlayers;
    }
};
VoyageService = _ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        ...
        typeof _voyagesetupservice.VoyageSetupService === "undefined" ? Object : _voyagesetupservice.VoyageSetupService,
        typeof _voyageactionservice.VoyageActionService === "undefined" ? Object : _voyageactionservice.VoyageActionService,
        typeof _voyagepresenterservice.VoyagePresenterService === "undefined" ? Object : _voyagepresenterservice.VoyagePresenterService,
        typeof _voyagebotservice.VoyageBotService === "undefined" ? Object : _voyagebotservice.VoyageBotService
    ])
], VoyageService);
