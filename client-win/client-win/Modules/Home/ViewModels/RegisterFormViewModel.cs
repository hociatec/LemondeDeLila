...
public sealed class RegisterFormViewModel : ObservableObject, IDisposable
{
    ...
    public RegisterFormViewModel(Func<RegisterFormViewModel, Task> onSubmit, Action onBack)
    {
